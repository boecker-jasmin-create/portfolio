...
const renderShowcasePanels = () => {
	showcasePanels.forEach((panel) => {
		...
		content.appendChild(createElement('h2', 'text-center mb-3 font-decorative fs-1', 'Mein Showcase zum Thema:'));
		content.appendChild(createElement('h2', 'text-center mb-2', panelData.title || 'Showcase'));
		if (panelData.intro) {
			content.appendChild(createElement('p', 'text-center showcase-panel-intro mb-3', panelData.intro));
		}
